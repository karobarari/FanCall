...
function ScoringGuide() {
  const rows = [
    {
      icon: '✓',
      label: 'Correct call',
      note: 'Each of the 3 calls you get right',
      pts: '+10',
      iconCls: 'bg-green/15 text-green',
      ptsCls: 'text-gold',
    },
    {
      icon: '✕',
      label: 'Wrong call',
      note: 'You still score even when you miss',
      pts: '+5',
      iconCls: 'bg-flag/15 text-flag',
      ptsCls: 'text-muted',
    },
    {
      icon: '−',
  ...
  return (
    <aside className="bg-panel border border-white/10 rounded-card p-[18px]">
      <header className="flex items-center justify-between mb-3.5">
        <span className="text-[15px] font-semibold">⚡ Scoring Guide</span>
      </header>
      ...
      <div className="flex flex-col gap-2.5">
        {rows.map((r) => (
          <div
            key={r.label}
            className="flex items-center gap-3 bg-panel-2 border border-white/10 rounded-[11px] p-3"
          >
            <span
              className={
            ...
            <span className={'ml-auto text-[15px] font-bold ' + r.ptsCls}>
              {r.pts}
            </span>
          </div>
        ))}
      ...
      <div className="mt-3.5 p-4 rounded-[11px] bg-gold/15 border border-gold/30 flex flex-col items-center gap-1 text-center">
        <span className="text-[11px] uppercase tracking-[0.6px] text-muted">
          Maximum per fixture
        </span>
