...
// needs a username before an account can exist — same requirement a
// password signup has, just reached via a different door. Team is
// auto-assigned to the pilot club, same as password signup.
export default function CompleteSignup() {
  ...
  async function submit() {
    ...
    setBusy(true);
    try {
      await apiPost("/auth/oauth/complete", { display_name: displayName });
      await refreshMe();
      navigate("/app");
    } catch (e) {
